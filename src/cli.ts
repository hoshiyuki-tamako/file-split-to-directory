...
new Command()
  ...
  .option('-o, --output <output>', 'The output root directory it will place on; default same as input directory', '')
  ...
  $ file-split-to-directory "/mnt/d/download" --chunk 4400 --async --output "/mnt/e/process"`)
  .parse();
